...
Task: build discovery run UI.

Deliverables:
1. Page showing discovery runs.
2. Page showing one discovery run details.
3. Show:
   - status
   - seed input
   - timestamps
   - evidence count
4. Add simple form to start fake discovery only.
5. Keep visual design clean and functional.
