...
Task: create import/export connector foundation.

Deliverables:
1. Define Importer and Exporter interfaces.
2. Implement file-based JSON import/export.
3. Export:
   - assets
   - facts
   - relationships
   - evidence metadata
4. Import should preserve evidence/source metadata when possible.
5. Add tests.

Constraints:
- Do not implement NetBox/Nautobot connector yet.
- Do not implement IPAM connector yet.
