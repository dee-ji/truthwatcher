...
- Persistent audit storage added for discovery execution and command evidence actions, including migration, repository/service validation, API metadata audit IDs, and safety documentation.
